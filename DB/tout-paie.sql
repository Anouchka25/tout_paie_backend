...
--
-- Host: localhost
-- Generation Time: May 28, 2019 at 04:29 PM
...
(3, 'Mahesh', '', 'mahesh@gmail.com', '$2y$10$wWie9b6EATZNXfentdcP3O0B5pngM7Vczw5O4x6PptPU85A4udaeG', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'U', '2019-05-28 13:53:11', '2019-05-28 13:53:11');
...
--
ALTER TABLE `tblAdvertisementsImages`
  MODIFY `AdvertisementsPhotoID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tblPostComments`
  MODIFY `PostCommentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tblProductBasket`
  MODIFY `ProductBasketID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tblProductCatalogue`
  MODIFY `ProductCatalogueID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `tblStoreRatings`
  MODIFY `StoreRatingID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
